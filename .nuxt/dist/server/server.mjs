import { getCurrentInstance, reactive, effectScope, ref, markRaw, toRaw, watch, unref, toRef, isRef, inject, version, defineComponent, computed, h, resolveComponent, nextTick, shallowRef, isReadonly, Transition, Suspense, provide, mergeProps, withCtx, createVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/_...all_-ecc426c1.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/_...all_-d42be7c8.js").then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    component: () => import("./_nuxt/test-4f89bec5.js").then((m) => m.default || m)
  },
  {
...
const app_vue_vue_type_style_index_0_setup_true_lang = "";
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component-b1b04254.js").then((r) => r.default || r));
    const IslandRendererer = defineAsyncComponent(() => import("./_nuxt/island-renderer-b32f59d0.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
