...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./error-404-13cff953.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./error-500-9d902d2e.js").then((r) => r.default || r));
...
//# sourceMappingURL=error-component-b1b04254.js.map
